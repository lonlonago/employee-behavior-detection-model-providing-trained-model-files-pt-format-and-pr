# Employee Behavior Detection Model providing trained model files (pt format) and process files.

# Body

Employee Behavior Detection Model, providing trained model files (pt format), process files, and validation images; with a dataset of 18,000 images, clear images, complete annotations, suitable for employee behavior detection, safety monitoring, factory workshops, offices, etc., ready to use directly, saving time and effort
